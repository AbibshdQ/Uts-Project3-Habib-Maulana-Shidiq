...
<div class="col-lg-6 mb-5">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Entri Absensi</h1>
    </div>
    <form method="post" action="{{ route('absensi-backend.store') }}">
        @csrf
        ...
        <div class="mb-2">
            <label for="tgl_absen" class="form-label">Tanggal Masuk</label>
        ...
        <div class="mb-2">
            ...
            <input class="form-control @error('waktu_tb') is-invalid @enderror" name="waktu_tb">{{ old('waktu_tb') }}</input>
            @error('waktu_tb')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
