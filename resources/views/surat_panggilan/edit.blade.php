...
<div class="col-lg-6 mb-5">
    ...
    <form method="post" action="/suratpanggil-backend/{{ $surat_panggilans->id }}">
        @method('put')
        @csrf
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control @error('no_surat') is-invalid @enderror" name="no_surat"
                value="{{$surat_panggilans->no_surat, old('no_surat') }}">
            @error('no_surat')
        ...
        <div class="mb-2">
            ...
            <input type="date" class="form-control @error('tgl_panggilan') is-invalid @enderror" name="tgl_panggilan"
                value="{{$surat_panggilans->tgl_panggilan, old('tgl_panggilan') }}">
            @error('tgl_panggilan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control @error('jam') is-invalid @enderror" name="jam"
                value="{{$surat_panggilans->jam, old('jam') }}">
            @error('jam')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control @error('tempat_panggil') is-invalid @enderror" name="tempat_panggil"
                value="{{$surat_panggilans->tempat_panggil, old('tempat_panggil') }}">
        ...
        <div class="mb-2">
            ...
            <input type="date" class="form-control @error('tgl_jbtan') is-invalid @enderror" name="tgl_jbtan"
                value="{{$surat_panggilans->tgl_jbtan, old('tgl_jbtan') }}">
            @error('tgl_jbtan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control @error('ket_panggil') is-invalid @enderror" name="ket_panggil"
                value="{{$surat_panggilans->ket_panggil, old('ket_panggil') }}">
            @error('ket_panggil')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control @error('nama_pemeriksa') is-invalid @enderror" name="nama_pemeriksa"
                value="{{$surat_panggilans->nama_pemeriksa, old('nama_pemeriksa') }}">
